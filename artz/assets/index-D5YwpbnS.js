...
`)}function Ef(n){return[n.extensionClipCullDistance?"#extension GL_ANGLE_clip_cull_distance : require":""].filter($n).join(`
...
`,oe={currentText:"Bring your message!",currentTheme:"ember",currentFont:"Outfit",activePreset:null,expansionDuration:pe.presets.DEFAULT.expansionDuration,contractionDuration:pe.presets.DEFAULT.contractionDuration,explosionMaxDistMultiplier:pe.presets.DEFAULT.explosionMaxDistMultiplier,activeExpansionDuration:null,activeContractionDuration:null,activeMaxDist:null,soundPitch:pe.presets.DEFAULT.soundPitch,soundDuration:pe.presets.DEFAULT.soundDuration,soundType:pe.presets.DEFAULT.soundType,get totalExplosionDuration(){const n=this.activeExpansionDuration||this.expansionDuration,e=this.activeContractionDuration||this.contractionDuration;return n+e}},he={scene:null,camera:null,renderer:null,particles:null,clock:new dp,targetZ:pe.initialZ,prevTime:0,prevDt:0,prevKFrame:0,prevDampFrame:0},Se={posHome:null,posLive:null,springDisp:null,springVel:null,randomDir:null,randomSpeed:null,explosionStartTime:-1,isWorkerBusy:!1},Ue={keys:{},mouseWorld:new U(-1e3,-1e3,0),mouseLocal:new U,invMatrix:new at,clickCount:0,lastClickTime:0,lastPinchDist:null,lastMidpoint:new Ye,lastGestureEndTime:0,inputDebounceTimer:null,toastTimer:null,isDragging:!1,prevMouseX:0,prevMouseY:0},en={uMouse:{value:new U(-1e3,-1e3,0)},uMouseInfluence:{value:pe.mouseInfluence},uPointSize:{value:pe.pointSize},uPixelRatio:{value:1},uColorHot:{value:new U(1,0,0)},uColorWarm:{value:new U(1,1,0)},uColorCold:{value:new U(1,1,1)},uExplosionProgress:{value:0},uTanHalfFov:{value:Math.tan(75*Math.PI/360)}};function mp(n){const e=document.getElementById("toast");e&&(e.textContent=n,e.classList.add("show"),clearTimeout(Ue.toastTimer),Ue.toastTimer=setTimeout(()=>{e.classList.remove("show")},3e3))}function fr(n){const e=document.getElementById("sr-announce");e&&(e.textContent=n)}let Dt=null;function _p(){try{Dt||(Dt=new(window.AudioContext||window.webkitAudioContext)),Dt.state==="suspended"&&Dt.resume();const n=Dt.currentTime,e=Dt.createOscillator(),t=Dt.createGain(),i=Dt.createBiquadFilter(),r=oe.soundPitch*(.85+Math.random()*.3),s=oe.soundDuration*(.85+Math.random()*.3);e.type=oe.soundType,e.frequency.setValueAtTime(r,n),e.frequency.exponentialRampToValueAtTime(30,n+s*.8);const o=oe.soundType==="sawtooth"?1200:700;i.type="lowpass",i.frequency.setValueAtTime(o,n),i.frequency.exponentialRampToValueAtTime(80,n+s*.9);const a=oe.soundType==="sawtooth"?.22:.4;t.gain.setValueAtTime(a,n),t.gain.exponentialRampToValueAtTime(.001,n+s),e.connect(i),i.connect(t),t.connect(Dt.destination),e.start(n),e.stop(n+s);const l=Dt.createOscillator(),c=Dt.createGain();l.type="triangle",l.frequency.setValueAtTime(r*2,n),l.frequency.exponentialRampToValueAtTime(90,n+.35),c.gain.setValueAtTime(.12,n),c.gain.exponentialRampToValueAtTime(.001,n+.35),l.connect(c),c.connect(Dt.destination),l.start(n),l.stop(n+.4)}catch(n){console.warn("Audio synthesis initialized with error:",n)}}const Za=new Set(["Outfit"]);async function gp(n){if(Za.has(n))return;const e={"Fira Code":"https://fonts.googleapis.com/css2?family=Fira+Code:wght@400;600&display=swap",Pacifico:"https://fonts.googleapis.com/css2?family=Pacifico&display=swap","Playfair Display":"https://fonts.googleapis.com/css2?family=Playfair+Display:ital,wght@0,400;0,700;1,400&display=swap"};if(e[n]){const t=document.createElement("link");t.rel="stylesheet",t.href=e[n],document.head.appendChild(t),Za.add(n)}}let ji=null,ja=null;function vp(n){ji||(ji=document.createElement("canvas"),ja=ji.getContext("2d",{willReadFrequently:!0}));const e=ji,t=ja;e.width=pe.canvasWidth,e.height=pe.canvasHeight,t.fillStyle="black",t.fillRect(0,0,pe.canvasWidth,pe.canvasHeight),t.fillStyle="white",t.font=`bold ${pe.fontSize}px "${oe.currentFont}", sans-serif`,t.textAlign="center",t.textBaseline="middle",t.fillText(n,pe.canvasWidth/2,pe.canvasHeight/2);const i=t.getImageData(0,0,pe.canvasWidth,pe.canvasHeight).data,r=[];let s=1/0,o=-1/0,a=1/0,l=-1/0;for(let d=0;d<pe.canvasHeight;d+=pe.pixelStep)for(let m=0;m<pe.canvasWidth;m+=pe.pixelStep){const _=(d*pe.canvasWidth+m)*4;i[_]>pe.pixelThreshold&&(r.push({x:m,y:d}),m<s&&(s=m),m>o&&(o=m),d<a&&(a=d),d>l&&(l=d))}if(r.length===0)return null;const c=pe.targetWorldWidth/Math.max(o-s,1),h=(s+o)/2,f=(a+l)/2;return r.map(d=>({x:(d.x-h)*c,y:(f-d.y)*c,z:0}))}let Kr=0;async function pr(n,e=!1){Kr++;const t=Kr;await gp(oe.currentFont);const i=`bold ${pe.fontSize}px "${oe.currentFont}"`;if(!document.fonts.check(i))try{await document.fonts.load(i)}catch(u){console.warn(`Failed to pre-load custom font "${oe.currentFont}":`,u)}if(t!==Kr)return;he.particles&&(he.particles.geometry.dispose(),he.particles.material&&he.particles.material.dispose(),he.scene.remove(he.particles),he.particles=null);const r=vp(n);if(!r){mp("Text must contain at least one visible character!");return}const{density:s,jitterXY:o,jitterZ:a,explosionSpeedMin:l,explosionSpeedRange:c}=pe;let h=r.length*s,f=1;const d=3e4;if(h>d){const u=Math.floor(d/s);f=Math.max(1,Math.ceil(r.length/u))}const m=[];for(let u=0;u<r.length;u+=f)m.push(r[u]);const _=m.length*s;Se.posHome=new Float32Array(_*3),Se.posLive=new Float32Array(_*3),Se.springDisp=new Float32Array(_*3),Se.springVel=new Float32Array(_*3),Se.randomDir=new Float32Array(_*3),Se.randomSpeed=new Float32Array(_);for(let u=0;u<m.length;u++){const y=m[u];for(let x=0;x<s;x++){const w=u*s+x,L=w*3,R=L+1,A=L+2,X=y.x+(Math.random()-.5)*o,S=y.y+(Math.random()-.5)*o,T=y.z+(Math.random()-.5)*a;Se.posHome[L]=X,Se.posHome[R]=S,Se.posHome[A]=T;const N=e?(Math.random()-.5)*45:0,k=e?(Math.random()-.5)*45:0,ee=e?(Math.random()-.5)*35:0;Se.posLive[L]=X+N,Se.posLive[R]=S+k,Se.posLive[A]=T+ee,Se.springDisp[L]=N,Se.springDisp[R]=k,Se.springDisp[A]=ee;const C=Math.random()*Math.PI*2,I=Math.acos(Math.random()*2-1);Se.randomDir[L]=Math.sin(I)*Math.cos(C),Se.randomDir[R]=Math.sin(I)*Math.sin(C),Se.randomDir[A]=Math.cos(I),Se.randomSpeed[w]=l+Math.random()*c}}const g=new nn;g.setAttribute("position",new Vt(Se.posLive,3));const p=new _n({uniforms:en,vertexShader:fp,fragmentShader:pp,blending:$r,depthWrite:!1,transparent:!0});he.particles=new hp(g,p),he.scene.add(he.particles),gn&&(gn.postMessage({type:"init",data:{posHome:Se.posHome,randomDir:Se.randomDir,randomSpeed:Se.randomSpeed}}),Se.isWorkerBusy=!1)}const $a=new U,Zr=new U;function vs(n,e){$a.set(n/window.innerWidth*2-1,-(e/window.innerHeight)*2+1,.5).unproject(he.camera),Zr.copy($a).sub(he.camera.position).normalize(),Ue.mouseWorld.copy(he.camera.position).add(Zr.multiplyScalar(-he.camera.position.z/Zr.z))}function xp(){if(!Se.randomDir||!Se.randomSpeed)return;const n=Se.randomSpeed.length,{explosionSpeedMin:e,explosionSpeedRange:t}=pe,i=Math.floor(Math.random()*4),r=(Math.random()-.5)*2,s=(Math.random()-.5)*2,o=(Math.random()-.5)*2,a=(Math.random()-.5)*2.5;for(let l=0;l<n;l++){const c=l*3,h=c+1,f=c+2;let d=Math.random()*Math.PI*2,m=Math.acos(Math.random()*2-1),_=Math.sin(m)*Math.cos(d),g=Math.sin(m)*Math.sin(d),p=Math.cos(m);if(i===1){const u=Math.atan2(g,_)+a,y=Math.sqrt(_*_+g*g);_=Math.cos(u)*y,g=Math.sin(u)*y}else if(i===2){_=_*.35+r*.65,g=g*.35+s*.65,p=p*.35+o*.65;const u=Math.sqrt(_*_+g*g+p*p)||1;_/=u,g/=u,p/=u}else if(i===3){const u=.5+.5*Math.sin(l*.08);Se.randomSpeed[l]=(e+Math.random()*t)*(.4+u)}if(i!==3){const u=.75+Math.random()*.55;Se.randomSpeed[l]=(e+Math.random()*t)*u}Se.randomDir[c]=_,Se.randomDir[h]=g,Se.randomDir[f]=p}}function ar(){Se.explosionStartTime>=0||(xp(),oe.activeMaxDist=oe.explosionMaxDistMultiplier*(.8+Math.random()*.4),oe.activeExpansionDuration=oe.expansionDuration*(.85+Math.random()*.3),oe.activeContractionDuration=oe.contractionDuration*(.85+Math.random()*.3),gn&&gn.postMessage({type:"init",data:{posHome:Se.posHome,randomDir:Se.randomDir,randomSpeed:Se.randomSpeed}}),Se.explosionStartTime=he.clock.getElapsedTime(),_p(),fr(`Explosion triggered for "${oe.currentText}"`))}function xs(n,e,t,i=!0){const r=new URL(window.location);r.searchParams.set("t",n),r.searchParams.set("theme",e),r.searchParams.set("font",t),i?window.history.pushState({},"",r):window.history.replaceState({},"",r)}function jr(){const n=pe.presets.DEFAULT;oe.expansionDuration=n.expansionDuration,oe.contractionDuration=n.contractionDuration,oe.explosionMaxDistMultiplier=n.explosionMaxDistMultiplier,oe.soundPitch=n.soundPitch,oe.soundDuration=n.soundDuration,oe.soundType=n.soundType}function cs(){if(oe.activePreset)return;const n=Object.keys(pe.presets).filter(i=>i!=="DEFAULT"),e=n[Math.floor(Math.random()*n.length)],t=pe.presets[e];oe.expansionDuration=t.expansionDuration,oe.contractionDuration=t.contractionDuration,oe.explosionMaxDistMultiplier=t.explosionMaxDistMultiplier,oe.soundPitch=t.soundPitch,oe.soundDuration=t.soundDuration,oe.soundType=t.soundType}function or(n,e=!0){const t=pe.themes[n]||pe.themes.ember;oe.currentTheme=n,en.uColorHot.value.set(t.hot[0],t.hot[1],t.hot[2]),en.uColorWarm.value.set(t.warm[0],t.warm[1],t.warm[2]),en.uColorCold.value.set(t.cold[0],t.cold[1],t.cold[2]);const i=document.getElementById("theme-select");i&&(i.value=n),xs(oe.currentText,oe.currentTheme,oe.currentFont,e),fr(`Theme changed to ${n}`)}async function Ms(n,e=!0,t=!1){oe.currentFont=n;const i=document.getElementById("font-select");i&&(i.value=n),await pr(oe.currentText,t),xs(oe.currentText,oe.currentTheme,oe.currentFont,e),fr(`Font changed to ${n}`)}async function Mp(n,e=!0){const t=n.trim(),i=t.length>0?t:"Bring your message!";oe.currentText=i,await pr(i,!1),xs(oe.currentText,oe.currentTheme,oe.currentFont,e),fr(`Text updated to "${oe.currentText}"`)}function us(n){const e=document.getElementById("char-counter");if(!e)return;const t=n.length;e.textContent=`${t}/25`,e.classList.remove("warning","danger"),t>=25?e.classList.add("danger"):t>=20&&e.classList.add("warning")}async function Io(n,e=!0){const t=pe.presets[n]||pe.presets.DEFAULT;oe.expansionDuration=t.expansionDuration,oe.contractionDuration=t.contractionDuration,oe.explosionMaxDistMultiplier=t.explosionMaxDistMultiplier,oe.soundPitch=t.soundPitch,oe.soundDuration=t.soundDuration,oe.soundType=t.soundType,t.theme&&or(t.theme,!0),t.font?await Ms(t.font,!0,e):await pr(oe.currentText,e)}function Sp(n){if(n.target.closest("#control-panel")||(n.pointerType==="mouse"&&(Ue.isDragging=!0,Ue.prevMouseX=n.clientX,Ue.prevMouseY=n.clientY),n.pointerType==="touch"&&!n.isPrimary))return;const e=performance.now();Ue.clickCount=e-Ue.lastClickTime<pe.tapWindowMs?Ue.clickCount+1:1,Ue.lastClickTime=e,Ue.clickCount>=pe.tapCount&&(cs(),ar(),Ue.clickCount=0)}function Ep(n){if(!n.target.closest("#control-panel")){if(n.touches.length===1)vs(n.touches[0].clientX,n.touches[0].clientY);else if(n.touches.length===2){const e=n.touches[0].clientX-n.touches[1].clientX,t=n.touches[0].clientY-n.touches[1].clientY;Ue.lastPinchDist=Math.sqrt(e*e+t*t),Ue.lastMidpoint.set((n.touches[0].clientX+n.touches[1].clientX)/2,(n.touches[0].clientY+n.touches[1].clientY)/2)}}}function Tp(n){if(!n.target.closest("#control-panel")){if(n.preventDefault(),n.touches.length===1)vs(n.touches[0].clientX,n.touches[0].clientY);else if(n.touches.length===2){const e=n.touches[0].clientX-n.touches[1].clientX,t=n.touches[0].clientY-n.touches[1].clientY,i=Math.sqrt(e*e+t*t);Ue.lastPinchDist&&(he.targetZ-=(i-Ue.lastPinchDist)*.15),Ue.lastPinchDist=i;const r=(n.touches[0].clientX+n.touches[1].clientX)/2,s=(n.touches[0].clientY+n.touches[1].clientY)/2;he.particles&&(he.particles.rotation.y+=(r-Ue.lastMidpoint.x)*.005,he.particles.rotation.x+=(s-Ue.lastMidpoint.y)*.005),Ue.lastMidpoint.set(r,s)}}}function Ja(n){n.pointerType==="mouse"&&(Ue.isDragging=!1)}function yp(){Ue.lastPinchDist=null,Ue.lastGestureEndTime=performance.now()}function Ap(){he.camera.aspect=window.innerWidth/window.innerHeight,he.camera.updateProjectionMatrix(),he.renderer.setSize(window.innerWidth,window.innerHeight);const n=Math.min(window.devicePixelRatio,pe.maxPixelRatio);he.renderer.setPixelRatio(n),en.uPixelRatio.value=n}function hs(n){oe.activePreset=n,document.querySelectorAll(".preset-chip").forEach(t=>{t.getAttribute("data-text")===n?t.classList.add("active"):t.classList.remove("active")})}function Ji(){oe.activePreset=null,document.querySelectorAll(".preset-chip").forEach(e=>{e.classList.remove("active")})}function bp(){const n=document.getElementById("text-input"),e=document.getElementById("theme-select"),t=document.getElementById("font-select"),i=document.getElementById("capture-btn");n&&(n.value=oe.currentText,us(oe.currentText),n.addEventListener("input",()=>{Ji(),jr(),us(n.value),clearTimeout(Ue.inputDebounceTimer),Ue.inputDebounceTimer=setTimeout(async()=>{await Mp(n.value)},pe.inputDebounceMs)})),e&&(e.value=oe.currentTheme,e.addEventListener("change",()=>{Ji(),jr(),or(e.value)})),t&&(t.value=oe.currentFont,t.addEventListener("change",async()=>{Ji(),jr(),await Ms(t.value)})),i&&i.addEventListener("click",()=>{he.renderer.render(he.scene,he.camera);const s=he.renderer.domElement.toDataURL("image/png"),o=document.createElement("a"),a=oe.currentText.replace(/[^a-z0-9]/gi,"_").toLowerCase();o.download=`artz-sculpture-${a||"kinetic"}.png`,o.href=s,o.click()}),document.querySelectorAll(".preset-chip").forEach(s=>{s.addEventListener("click",async()=>{const o=s.getAttribute("data-text");await Io(o),hs(o),ar()})})}function No(){requestAnimationFrame(No);const n=he.clock.getElapsedTime(),e=Math.min(n-he.prevTime,.05);he.prevTime=n;const{keys:t,invMatrix:i,lastGestureEndTime:r}=Ue,{particles:s,camera:o}=he;if(s){t.ArrowUp&&(s.rotation.x-=pe.rotationStep),t.ArrowDown&&(s.rotation.x+=pe.rotationStep),t.ArrowLeft&&(s.rotation.y-=pe.rotationStep),t.ArrowRight&&(s.rotation.y+=pe.rotationStep);const T=t.ArrowUp||t.ArrowDown||t.ArrowLeft||t.ArrowRight,N=performance.now()-r<pe.autoReturnGracePeriodMs;if(!T&&!Ue.lastPinchDist&&!N&&!Ue.isDragging){const k=pe.rotationAutoReturnLerp;s.rotation.x=yi.lerp(s.rotation.x,0,k),s.rotation.y=yi.lerp(s.rotation.y,0,k)}}if((t["+"]||t["="])&&(he.targetZ-=pe.zoomSpeed),t["-"]&&(he.targetZ+=pe.zoomSpeed),he.targetZ=yi.clamp(he.targetZ,pe.zoomMin,pe.zoomMax),o.position.z=yi.lerp(o.position.z,he.targetZ,pe.zoomLerp),!s){he.renderer.render(he.scene,o);return}i.copy(s.matrixWorld).invert(),Ue.mouseLocal.copy(Ue.mouseWorld).applyMatrix4(i),en.uMouse.value.copy(Ue.mouseLocal);const a=s.geometry.attributes.position,l=a.array,c=a.count,{posHome:h,springDisp:f,springVel:d,randomDir:m,randomSpeed:_}=Se,g=pe.mouseInfluence,p=g*g,u=pe.repulsionStrength,y=Ue.mouseLocal;let x,w;Math.abs(e-he.prevDt)<1e-4?(x=he.prevKFrame,w=he.prevDampFrame):(x=pe.springK*(e*60),w=Math.pow(pe.springDamping,e*60),he.prevDt=e,he.prevKFrame=x,he.prevDampFrame=w);let L=-1,R=0;const A=oe.activeExpansionDuration||oe.expansionDuration,X=oe.activeContractionDuration||oe.contractionDuration,S=oe.activeMaxDist||oe.explosionMaxDistMultiplier;if(Se.explosionStartTime>0&&(L=n-Se.explosionStartTime,L>oe.totalExplosionDuration?(Se.explosionStartTime=-1,L=-1):L<A?R=L/A:R=1-(L-A)/X),en.uExplosionProgress.value=R,he.particles&&(he.particles.frustumCulled=R===0),gn)Se.isWorkerBusy||(Se.isWorkerBusy=!0,gn.postMessage({type:"update",data:{posLive:Se.posLive,springDisp:Se.springDisp,springVel:Se.springVel,count:c,dt:e,time:n,elapsed:L,isMotionReduced:ls,mouseLocal:{x:y.x,y:y.y,z:y.z},kFrame:x,dampFrame:w,expansionDuration:A,contractionDuration:X,explosionMaxDistMultiplier:S,mouseInfluence:g,repulsionStr:u}}));else{for(let T=0;T<c;T++){const N=T*3,k=N+1,ee=N+2;let C=h[N],I=h[k],H=h[ee];if(!ls){const ue=n*1.3+T*.005;C+=Math.sin(ue)*.12,I+=Math.cos(ue*.8)*.08,H+=Math.sin(ue*.5)*.15}if(L>0){const ue=_[T]*S,Ae=m[N],Ce=m[k],xe=m[ee];let Oe;if(L<A){const D=L/A;Oe=ue*D*(2-D)}else{const D=(L-A)/X;Oe=ue*(1-D*D*D)}C+=Ae*Oe,I+=Ce*Oe,H+=xe*Oe}const q=l[N],W=l[k],V=l[ee],K=q-y.x,$=W-y.y,le=V-y.z,G=K*K+$*$+le*le;let Y=0,se=0,me=0;if(G<p&&G>1e-5){const ue=Math.sqrt(G),Ae=1/ue,Ce=(g-ue)/g,xe=u*Ce;Y=K*Ae*xe,se=$*Ae*xe,me=le*Ae*xe}d[N]=(d[N]+(Y-f[N])*x)*w,d[k]=(d[k]+(se-f[k])*x)*w,d[ee]=(d[ee]+(me-f[ee])*x)*w,f[N]+=d[N],f[k]+=d[k],f[ee]+=d[ee],l[N]=C+f[N],l[k]=I+f[k],l[ee]=H+f[ee]}a.needsUpdate=!0}he.renderer.render(he.scene,o)}async function wp(){he.scene=new cp,he.camera=new It(75,window.innerWidth/window.innerHeight,.1,1e3),he.camera.position.z=he.targetZ;const n=Math.min(window.devicePixelRatio,pe.maxPixelRatio);he.renderer=new Uo({antialias:!0,alpha:!1,powerPreference:"high-performance",preserveDrawingBuffer:!1}),he.renderer.setClearColor(pe.clearColor,1),he.renderer.setSize(window.innerWidth,window.innerHeight),he.renderer.setPixelRatio(n),en.uPixelRatio.value=n;const e=he.renderer.domElement;e.setAttribute("role","img"),e.setAttribute("aria-label","Kinetic particle sculpture — interactive particle animation"),document.body.appendChild(e);try{gn=new Worker(new URL("/artz/assets/physics.worker-CE_Oj5xk.js",import.meta.url),{type:"module"}),gn.onmessage=function(a){const{type:l,posLive:c,springDisp:h,springVel:f}=a.data;if(l==="update"){if(Se.posLive=c,Se.springDisp=h,Se.springVel=f,he.particles){const d=he.particles.geometry.attributes.position;d.array=Se.posLive,d.needsUpdate=!0}Se.isWorkerBusy=!1}}}catch(a){console.error("Failed to initialize physics Web Worker:",a)}await document.fonts.ready.catch(()=>{});const t=new URLSearchParams(window.location.search),i=t.get("t")||"Bring your message!",r=t.get("theme")||"ember",s=t.get("font")||"Outfit";oe.currentText=i,oe.currentTheme=r,oe.currentFont=s;const o=i.toUpperCase();pe.presets[o]&&o!=="DEFAULT"?(await Io(o,!1),hs(o)):(or(r,!1),await pr(oe.currentText,!1)),bp(),window.addEventListener("pointermove",a=>{if(vs(a.clientX,a.clientY),Ue.isDragging&&a.pointerType==="mouse"){const l=a.clientX-Ue.prevMouseX,c=a.clientY-Ue.prevMouseY;he.particles&&(he.particles.rotation.y+=l*.005,he.particles.rotation.x+=c*.005),Ue.prevMouseX=a.clientX,Ue.prevMouseY=a.clientY,Ue.lastGestureEndTime=performance.now()}}),window.addEventListener("pointerdown",Sp),window.addEventListener("pointerup",Ja),window.addEventListener("pointercancel",Ja),window.addEventListener("pointerleave",()=>{Ue.mouseWorld.set(-1e3,-1e3,0),en.uMouse.value.set(-1e3,-1e3,0),Ue.isDragging=!1}),window.addEventListener("dblclick",a=>{a.target.closest("#control-panel")||(cs(),ar())}),window.addEventListener("touchstart",Ep,{passive:!1}),window.addEventListener("touchmove",Tp,{passive:!1}),window.addEventListener("touchend",yp),window.addEventListener("resize",Ap),window.addEventListener("keydown",a=>{Ue.keys[a.key]=!0,a.code==="Space"&&document.activeElement.tagName!=="INPUT"&&document.activeElement.tagName!=="SELECT"&&(a.preventDefault(),cs(),ar())}),window.addEventListener("keyup",a=>Ue.keys[a.key]=!1),window.addEventListener("popstate",async()=>{const a=new URLSearchParams(window.location.search),l=a.get("t")||"Bring your message!",c=a.get("theme")||"ember",h=a.get("font")||"Outfit";oe.currentText=l,oe.currentTheme=c,oe.currentFont=h;const f=document.getElementById("text-input");f&&(f.value=l,us(l)),or(c,!1),await Ms(h,!1);const d=l.toUpperCase();pe.presets[d]&&d!=="DEFAULT"?hs(d):Ji()}),No()}wp();
